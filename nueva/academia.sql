...
12) Pesquisar a media de preço dos produtos no estoque.

selec avg(valor) from produto;

13) Pesquisar o produto com menor preço em estoque.

selecmin(valor) from produto;

14) Pesquisar o producto com maior valor em estoque.
...
select aluno.nome, aluno.telefone, endereco.rua,aluno.numero casa,endereco.bairro
from aluno inner join endereco e
on e.cep = a.cep;

16) Pesquisar nome da atividade, data da aula e horario de todas as aulas do 
...
17) Pesquisar nome a telefone de todos os professores.

select f.nome,f.telefone
from funcionario f inner join professor p
on f. cpffuncionario = p.cpffuncionario;

18) Pesquisar o nome e valor da venda de todos os funcionarios que fizeram venda
no mes de dezembro.
...
19) Pesquisar nome da atividade, data da aula e horario de todas as aulas do 
mes de dezembro 2022.
